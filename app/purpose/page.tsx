        ...
        <section className="mb-24">
          <motion.div initial={{ opacity: 0, y: 80 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }} viewport={{ once: true, amount: 0.2 }} className="purpose-card group relative bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl p-8 md:p-12 mb-12 overflow-hidden hover:border-blue-400/30 hover:shadow-2xl transition-all duration-700">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
              <motion.div animate={{ y: [0, -20, 0], x: [0, 10, 0], opacity: [0.1, 0.3, 0.1] }} transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }} className="absolute top-10 right-20 w-32 h-32 bg-blue-500/10 rounded-full blur-3xl" />
            ...
            <div className="relative z-10">
                  <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.6, delay: 0.2 }} viewport={{ once: true }} className="mb-6">
                    <div className="inline-flex items-center gap-3 mb-4">
                      <motion.div animate={{ rotate: 360 }} transition={{ duration: 20, repeat: Infinity, ease: "linear" }} className="w-12 h-12 bg-linear-to-br from-blue-400 to-indigo-500 rounded-xl flex items-center justify-center shadow-lg">
                  ...
                  <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.4 }} viewport={{ once: true }} className="space-y-6">
                    <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.5 }} viewport={{ once: true }} className="text-lg md:text-xl text-slate-300 leading-relaxed font-medium">
                      Electivio exists to <span className="text-blue-400 font-semibold">simplify and standardize</span> access to medical observerships and elective programs across the UAE.
                    </motion.p>
                    <motion.div initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.6 }} viewport={{ once: true }} className="pl-4 border-l-2 border-blue-400">
                    ...
                    <motion.div initial={{ opacity: 0, scale: 0.95 }} whileInView={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.8 }} viewport={{ once: true }} className="mt-8 p-6 rounded-2xl bg-linear-to-r from-blue-500/10 to-indigo-500/10 border border-blue-500/20">
                      <p className="text-lg text-blue-300 leading-relaxed font-medium text-center">
                        💡 Our purpose is not to replace institutional processes, but to <span className="text-blue-200 font-bold">support them</span> through clarity, structure, and transparency.
                      </p>
                    </motion.div>
                  </motion.div>
            </div>
            ...
            <StaggerItem>
              <ScrollReveal direction="left" delay={0}>
                <div className="purpose-card bg-white/5 border border-white/10 rounded-2xl backdrop-blur-xl p-8 hover:bg-white/10 hover:shadow-xl transition-all duration-500">
                  <h3 className="text-2xl font-bold text-blue-400 mb-3">1. Program Standardization</h3>
                  <p className="text-lg text-slate-400 leading-relaxed">
        ...
        <section className="mb-24">
          <motion.div initial={{ opacity: 0, y: 80 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }} className="purpose-card bg-linear-to-br from-emerald-500/10 to-indigo-500/10 border border-white/10 rounded-3xl backdrop-blur-xl p-8 md:p-12 shadow-xl">
            ...
            <ul className="space-y-3 mb-8">
              ...
              <li className="flex items-start">
                <span className="inline-flex items-center justify-center w-6 h-6 rounded-full bg-blue-500/30 mr-3 mt-1 shrink-0">
            ...
            <div className="relative">
              ...
              >
                ...
                <motion.div
                  ...
                  className="relative"
                >
                  <div className="w-12 h-12 rounded-full bg-linear-to-br from-blue-500 to-indigo-600 border-2 border-white backdrop-blur-md flex items-center justify-center shadow-2xl">
        ...
        <section className="mb-16 md:mb-24">
            ...
            <div className="flex justify-center gap-3 mb-6 md:mb-8">
              <button
                ...
                className={`px-6 py-2 rounded-full font-semibold transition-all duration-300 ${
                  activeCard === "students"
                    ? "bg-linear-to-r from-blue-600 to-blue-600 text-white shadow-lg"
          ...
          <div className="relative h-72 md:h-72">
            <AnimatePresence mode="wait">
              {activeCard === "students" ? (
                <motion.div key="students" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }} className="purpose-card absolute inset-0 bg-linear-to-br from-blue-500/10 to-blue-500/10 border border-white/10 rounded-3xl backdrop-blur-xl p-7 md:p-12 shadow-2xl overflow-hidden group">
                  <div className="absolute -top-40 -right-40 w-80 h-80 bg-blue-500/20 rounded-full blur-3xl group-hover:scale-110 transition-transform duration-500" />
                  <div className="relative z-10">
                    <h3 className="text-3xl font-bold text-blue-300 mb-4 md:mb-6">Browse Programs</h3>
                    ...
                    <Link href="/programs">
                      <Button size="lg" className="bg-blue-600 text-white hover:bg-blue-700 font-semibold shadow-lg hover:shadow-xl">
                        Explore Programs
                      </Button>
                    </Link>
                  </div>
                ...
                <motion.div key="hospitals" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }} transition={{ duration: 0.3 }} className="purpose-card absolute inset-0 bg-linear-to-br from-emerald-500/10 to-blue-500/10 border border-white/10 rounded-3xl backdrop-blur-xl p-7 md:p-12 shadow-2xl overflow-hidden group">
